...
public class CashierStatsRepositoryImpl implements CashierStatsRepository {
    private final Pool client;

    @Override
    public Future<List<CashierMonthTotalSales>> getMonthlyTotalSales(MonthTotalSales req) {
        return client
                .preparedQuery(
                        """
                                WITH
