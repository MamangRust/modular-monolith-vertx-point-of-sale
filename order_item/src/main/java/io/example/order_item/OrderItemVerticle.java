...
public class OrderItemVerticle extends AbstractVerticle {
    ...
    public void start(Promise<Void> startPromise) {
        ...
        OrderItemCommandService cmdService = new OrderItemCommandServiceImpl(cmdRepo, queryRepo, redisService, tracingMetrics);
        ...
        final int port = tempPort > 0 ? tempPort : 50057;
    ...
    private Future<Void> startGrpcServer(OrderItemQueryHandler queryHandler, OrderItemCommandHandler cmdHandler, int grpcPort, ChaosManager chaosManager) {
