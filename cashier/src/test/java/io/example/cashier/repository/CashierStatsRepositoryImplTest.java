...
class CashierStatsRepositoryImplTest {
    ...
    private CashierStatsRepositoryImpl repository;

    @BeforeEach
    void setUp() {
        repository = new CashierStatsRepositoryImpl(client);
    }
    ...
    @Test
    void getMonthlyTotalSales_shouldReturnMappedList() {
        ...
        Future<List<CashierMonthTotalSales>> result = repository.getMonthlyTotalSales(req);
    ...
    @Test
    void getYearlyTotalSales_shouldReturnMappedList() {
        Row r = mock(Row.class);
        when(r.getString("year")).thenReturn("2024");
        ...
        Future<List<CashierYearTotalSales>> result = repository.getYearlyTotalSales(2024);
    ...
    @Test
    void getMonthlyCashier_shouldReturnMappedList() {
        Row r = mock(Row.class);
        ...
        Future<List<CashierMonthSales>> result = repository.getMonthlyCashier(2024);
    ...
    @Test
    void getYearlyCashier_shouldReturnMappedList() {
        Row r = mock(Row.class);
        when(r.getString("year")).thenReturn("2024");
        when(r.getInteger("cashier_id")).thenReturn(1);
        when(r.getString("cashier_name")).thenReturn("John");
        ...
        Future<List<CashierYearSales>> result = repository.getYearlyCashier(2024);
