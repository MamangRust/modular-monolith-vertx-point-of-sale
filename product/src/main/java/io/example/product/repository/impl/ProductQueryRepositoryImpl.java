...
public class ProductQueryRepositoryImpl implements ProductQueryRepository {
    ...
    public Future<PagedResult<Product>> getProductsByMerchant(ProductByMerchantRequest req) {
        ...
        return client
                .preparedQuery("""
                        ...
                        OFFSET $7;
                        """)
                .execute(Tuple.of(req.getMerchantId().longValue(), req.getSearch(), catIdVal, minPriceVal, maxPriceVal,
    ...
    public Future<PagedResult<Product>> getProductsByCategoryName(ProductByCategoryRequest req) {
        ...
        return client
                .preparedQuery("""
                        ...
                        OFFSET $6;
                        """)
                .execute(Tuple.of(req.getCategoryName(), req.getSearch(), req.getMinPrice(), req.getMaxPrice(),
                        req.getPageSize(), offset))
                .map(this::mapPagedProducts);
    }
    ...
    @Override
    public Future<Product> findByTrashedId(Long productId) {
        return client
                .preparedQuery("""
                        SELECT
                            product_id,
