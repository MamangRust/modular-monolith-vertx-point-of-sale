...
public class CategoryStatsByMerchantRepositoryImpl implements CategoryStatsByMerchantRepository {
    private final Pool client;

    public CategoryStatsByMerchantRepositoryImpl(Pool client) {
        this.client = client;
    }
