...
public class ProductVerticle extends AbstractVerticle {
    ...
    public void start(Promise<Void> startPromise) {
        ...
        ProductCommandService cmdService = new ProductCommandServiceImpl(cmdRepo, queryRepo, categoryRepo, merchantRepo, redisService, tracingMetrics);
    ...
    private Future<Void> startGrpcServer(ProductQueryHandler queryHandler, ProductCommandHandler cmdHandler, int grpcPort, ChaosManager chaosManager) {
