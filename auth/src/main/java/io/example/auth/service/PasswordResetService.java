...
public class PasswordResetService {
    ...
    public Future<Boolean> forgotPassword(String email) {
        ...
        return userRepository.findByEmail(email)
                ...
                .onSuccess(
                        v -> tracingMetrics.completeSpanSuccess(tracingContext, method,
                                "Forgot password email process completed"))
        ...
        return redisService.get("resetToken:" + request.getResetToken())
                .compose(cachedUserId -> {
                    ...
                    return resetTokenRepository.findByToken(request.getResetToken())
                            .compose(rt -> {
                                if (rt == null) {
                                    return Future.failedFuture(new BadRequestException("Invalid or expired reset token"));
                                }
