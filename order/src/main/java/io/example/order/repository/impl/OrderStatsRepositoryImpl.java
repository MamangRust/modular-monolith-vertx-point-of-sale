...
public class OrderStatsRepositoryImpl implements OrderStatsRepository {
    ...
    @Override
    public Future<List<OrderYearTotalRevenue>> getYearlyTotalRevenue(int year) {
        return client.preparedQuery(
                """
    ...
    @Override
    public Future<List<OrderMonth>> getMonthlyOrder(int year) {
    ...
    @Override
    public Future<List<OrderYear>> getYearlyOrder(int year) {
        LocalDateTime refTs = LocalDateTime.of(year, 1, 1, 0, 0);
        return client.preparedQuery(
                """
