...
public class ProtoConverter {
    ...
    public static pb.order_item.OrderItem.OrderItemResponseDeleteAt fromOrderItemResponseDeleteAt(
            OrderItemResponseDeleteAt r) {
        if (r == null)
            return pb.order_item.OrderItem.OrderItemResponseDeleteAt.getDefaultInstance();
        pb.order_item.OrderItem.OrderItemResponseDeleteAt.Builder b = pb.order_item.OrderItem.OrderItemResponseDeleteAt
                .newBuilder()
                .setId(r.getId() != null ? r.getId().intValue() : 0)
                .setOrderId(r.getOrderId() != null ? r.getOrderId().intValue() : 0)
                .setProductId(r.getProductId() != null ? r.getProductId().intValue() : 0)
