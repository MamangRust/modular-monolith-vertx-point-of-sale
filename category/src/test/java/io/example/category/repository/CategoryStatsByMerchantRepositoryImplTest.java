...
class CategoryStatsByMerchantRepositoryImplTest {
    ...
    private CategoryStatsByMerchantRepositoryImpl repository;

    @BeforeEach
    void setUp() {
        repository = new CategoryStatsByMerchantRepositoryImpl(client);
    }
    ...
    @Test
    void getMonthlyTotalPriceByMerchant_shouldReturnMappedList() {
        ...
        Future<List<CategoryMonthTotalPrice>> result = repository.getMonthlyTotalPriceByMerchant(req);
    ...
    @Test
    void getYearlyTotalPriceByMerchant_shouldReturnMappedList() {
        ...
        Future<List<CategoryYearTotalPrice>> result = repository.getYearlyTotalPriceByMerchant(req);
    ...
    @Test
    void getMonthlyCategoryByMerchant_shouldReturnMappedList() {
        ...
        Future<List<CategoryMonthPrice>> result = repository.getMonthlyCategoryByMerchant(req);
    ...
    @Test
    void getYearlyCategoryByMerchant_shouldReturnMappedList() {
        ...
        Future<List<CategoryYearPrice>> result = repository.getYearlyCategoryByMerchant(req);
